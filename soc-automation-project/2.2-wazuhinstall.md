...
Accessing the server console via SSH in the browser didn't work for me, so I used PuTTY instead. I was able to connect easily. I actually tried connecting using the Windows terminal, but I just couldn't get it to work. After trying for three days, I gave up and tried PuTTY, which worked in 2 minutes. 
